...
If, for example, we want to change the chemical shift anisotropy ($\delta_\text{aniso}$) and asymmetry ($\eta$),
to fit a spectrum, we could use the following SIMPSON spinsys:
